...
import { ChevronDown, Car, Palette, Hash, Check, Edit2 } from "lucide-react";
...
export default function VehicleInfoPage() {
  ...
  return (
    <div className="flex flex-col" style={{ height: "100%", background: "#FAFAF9" }}>
      <PageHeader title={saved ? "Change Vehicle" : "Vehicle Details"} onBack={() => saved ? setEditing(false) : navigate(-1)} />
