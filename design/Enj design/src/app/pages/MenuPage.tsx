...
export default function MenuPage() {
  ...
  return (
    <div className="flex flex-col" style={{ minHeight: "100%", background: "#FAFAF9" }}>
      <div className="flex items-center justify-between px-5 pt-5 pb-4" style={{ background: "#FFFFFF", borderBottom: "1px solid #E2E8F0" }}>
        <AppLogoStatic height={30} />
        <span style={{ fontFamily: "'Poppins', sans-serif", fontSize: "17px", fontWeight: 600, color: "#1E293B" }}>Menu</span>
      </div>
