  ...
  return (
    <div className="flex flex-col" style={{ height: "100%", background: "#FAFAF9" }}>
      <div className="flex items-center justify-between px-4 pt-5 pb-4" style={{ background: "#FFFFFF", borderBottom: "1px solid #E2E8F0", flexShrink: 0 }}>
        ...
        <span style={{ fontFamily: "'Poppins', sans-serif", fontSize: "15px", fontWeight: 600, color: "#1E293B" }}>Change Phone Number</span>
      </div>
      ...
      <div className="px-5 py-6 flex flex-col gap-5">
        ...
        <button
          onClick={() => isValid && navigate("/otp", { state: { phone: `+63 ${digits.slice(0,3)} ${digits.slice(3,6)} ${digits.slice(6)}`, dest: "/menu" } })}
          disabled={!isValid}
