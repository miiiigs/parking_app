...
export default function ParkingDetailPage() {
  ...
  return (
    <div className="flex flex-col" style={{ height: "100%", background: "#FAFAF9", position: "relative" }}>
      <div style={{ background: "#FFFFFF", borderBottom: "1px solid #E2E8F0", flexShrink: 0, padding: "14px 16px", display: "flex", alignItems: "center", position: "relative" }}>
        <button onClick={() => navigate(-1)} style={{ width: "36px", height: "36px", borderRadius: "10px", background: "#F1F5F9", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, zIndex: 1 }}>
          <ChevronLeft size={20} style={{ color: "#1E293B" }} />
        </button>
        <div style={{ position: "absolute", left: 0, right: 0, textAlign: "center", pointerEvents: "none" }}>
          <p style={{ fontFamily: "'Poppins', sans-serif", fontSize: "15px", fontWeight: 600, color: "#1E293B", margin: 0, lineHeight: 1.3, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", paddingInline: "60px" }}>{lot.name}</p>
          <div className="flex items-center justify-center gap-1"><MapPin size={9} style={{ color: "#94A3B8", flexShrink: 0 }} /><span style={{ fontFamily: "'Poppins', sans-serif", fontSize: "10px", color: "#64748B" }}>{lot.type}</span></div>
        </div>
      </div>
