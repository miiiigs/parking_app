...
export default function ActiveSessionPage() {
    ...
    return (
      <div className="flex flex-col" style={{ minHeight: "100%", background: "#FAFAF9" }}>
        ...
        <div style={{ background: "#FFFFFF", padding: "18px 16px 16px", borderBottom: "1px solid rgba(15,23,42,0.07)" }}>
          <p style={{ fontFamily: "'Poppins', sans-serif", fontSize: "20px", fontWeight: 700, color: "#0F172A", margin: 0 }}>Active Session</p>
          <p style={{ fontFamily: "'Poppins', sans-serif", fontSize: "12px", color: "#94A3B8", margin: "4px 0 0" }}>No active parking session</p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center flex-1 px-8 text-center" style={{ paddingBottom: "60px" }}>
          ...
          <div style={{ width: "100px", height: "100px", borderRadius: "50%", background: "#F0FDFA", border: "2px solid #CCFBF1", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "24px" }}>
            <Car size={44} style={{ color: "#0D9488" }} />
          </div>
  ...
  return (
    <div className="flex flex-col" style={{ minHeight: "100%", background: "#FAFAF9" }}>
      {/* Header */}
      <div style={{ background: "#FFFFFF", padding: "18px 16px 14px", borderBottom: "1px solid rgba(15,23,42,0.07)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <p style={{ fontFamily: "'Poppins', sans-serif", fontSize: "20px", fontWeight: 700, color: "#0F172A", margin: 0 }}>Active Session</p>
        <div style={{ display: "flex", alignItems: "center", gap: "6px", background: "#ECFDF5", border: "1px solid #A7F3D0", borderRadius: "20px", padding: "4px 10px" }}>
          <div className="animate-pulse" style={{ width: "7px", height: "7px", borderRadius: "50%", background: "#34D399" }} />
          <span style={{ fontFamily: "'Poppins', sans-serif", fontSize: "11px", fontWeight: 600, color: "#0F766E" }}>LIVE</span>
        </div>
      </div>
