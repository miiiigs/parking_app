...
import { ChevronLeft, CreditCard, Car, Zap, ChevronRight, Check, ChevronDown, Palette, Hash, Edit2 } from "lucide-react";
  ...
  return (
    <div className="flex flex-col" style={{ height: "100%", background: "#FAFAF9" }}>
      <div className="flex items-center justify-between px-4 pt-5 pb-4"
        ...
        <span style={{ fontFamily: "'Poppins', sans-serif", fontSize: "15px", fontWeight: 600, color: "#1E293B" }}>Walk-In Parking</span>
      </div>
