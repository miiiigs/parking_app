...
export default function ReportIssuePage() {
  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center justify-center px-6 text-center" style={{ height: "100%", background: "#FAFAF9" }}>
        ...
        <button onClick={() => navigate("/profile")} style={{ width: "100%", height: "52px", borderRadius: "14px", background: "#0F766E", color: "#FFFFFF", fontFamily: "'Poppins', sans-serif", fontSize: "16px", fontWeight: 500, border: "none", cursor: "pointer", boxShadow: "0 6px 20px rgba(15,118,110,0.3)" }}>Back to Menu</button>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col" style={{ height: "100%", background: "#FAFAF9" }}>
      <PageHeader title="Report an Issue" onBack={() => navigate("/profile")} />
